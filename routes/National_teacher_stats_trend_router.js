...
WHERE
    details.submission_id = inspection.school_name AND details.region = '${nameOfRegion}' AND DATE_FORMAT(inspection.date_of_inspection,'%Y') =  '${year}' AND inspection.term != 'NULL'
GROUP BY
    inspection.term
ORDER BY
    inspection.term ASC`;
