...
router.get('/:name_of_school', function(req, res, next) {
    ...
    const limit = 1;
    const rQuery = `select details.name_of_school as school, inspection.date_of_inspection as inspection_date, inspection.established_staffing_as_per_enrollment as enrol,
    inspection.current_staffing_level as staff,
    inspection.staff_attendance_on_visit_day as attend,
    inspection.no_of_teachers_teaching_according_to_timetable as timetable FROM  ft_form_12  as inspection,  ft_form_11  as details
      WHERE details.submission_id=inspection.school_name  and details.name_of_school ='${nameOfSchool}' group by details.name_of_school,inspection.date_of_inspection`;
