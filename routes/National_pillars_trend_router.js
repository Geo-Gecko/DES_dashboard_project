...
router.get('/:region', function(req, res, next) {
    ...
    const limit = 1;
    const P1Query = `select distinct(region) as region, inspection.term as inspection_date, cast(avg(inspection.condition_of_school_building_and_compound) as unsigned) +
