...
router.get('/:region', function (req, res, next) {
    ...
    const dQuery = `select distinct(region) as region, sum(classroompupil_ratio_cpr_at_lower_primary_p1__p3) as cprp1p3, 
    sum(classroompupil_ratio_cpr_at_upper_primary_p4__p7) as cprp4__p7  from tbl_random  where region = '${nameOfRegion}' limit ${limit}`;
